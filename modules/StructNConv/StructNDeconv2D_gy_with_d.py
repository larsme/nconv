...
class StructNDeconv2d_gy_with_ds(_ConvNd):
    ...
    def forward(self, d, cd, gy, cgy):
        ...
        nom = F.conv3d(cgy_roll * gy_roll, self.statial_weight, self.groups)
        denom = F.conv3d(cgy_roll, self.statial_weight, self.groups)
