...
###### Training Set ######
    train_data_path = os.path.join(kitti_depth_dir, 'train')
    train_gt_path = os.path.join(kitti_depth_dir, 'train')
...
###### Validation Set ######
    val_data_path = os.path.join(kitti_depth_dir, 'val')
    val_gt_path = os.path.join(kitti_depth_dir, 'val')
...
###### Selected Validation set ######
    selval_data_path = os.path.join(kitti_depth_dir, 'val_selection_cropped/velodyne_raw')
    selval_gt_path = os.path.join(kitti_depth_dir, 'val_selection_cropped/groundtruth_depth')

    image_datasets['selval'] = KittiDepthDataset(selval_data_path, selval_gt_path, setname='selval', transform=None, norm_factor = norm_factor, invert_depth = invert_depth,
                                                 load_rgb=load_rgb, rgb_dir=kitti_rgb_dir, rgb2gray=rgb2gray)
...
###### Selected test set ######
    test_data_path = os.path.join(kitti_depth_dir, 'test_depth_completion_anonymous/velodyne_raw')
    test_gt_path = os.path.join(kitti_depth_dir, 'test_depth_completion_anonymous/velodyne_raw')
