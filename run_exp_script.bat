...
python run_nconv_cnn.py  -mode traineval -network_file Unguided_de2 -ws_path workspace/StructNConv/Unguided_de -params_sub_dir Experiments/sep_pow -exp_subdir reccurrent1 -evaluate_all_epochs true
python run_nconv_cnn.py  -mode traineval -network_file Unguided_de2 -ws_path workspace/StructNConv/Unguided_de -params_sub_dir Experiments/sep_pow -exp_subdir reccurrent2 -evaluate_all_epochs true
