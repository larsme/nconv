...
python run_nconv_cnn.py  -mode traineval -network_file Unguided_de -ws_path workspace/StructNConv/Unguided_de -params_sub_dir Experiments/sep_pow_smoothl1_default_init -exp_subdir 1 -evaluate_all_epochs true
python run_nconv_cnn.py  -mode traineval -network_file Unguided_de -ws_path workspace/StructNConv/Unguided_de -params_sub_dir Experiments/sep_pow_smoothl1_default_init -exp_subdir 2 -evaluate_all_epochs true
