...
class CNN(nn.Module):
    ...
    def __init__(self, params, num_channels=2):
        ...
        self.nconv1 = NConv2d(1, num_channels, (5, 5), self.pos_fn, 'x', padding=2)
        self.nconv2 = NConv2d(num_channels, num_channels, (5, 5), self.pos_fn, 'x', padding=2)
        self.nconv3 = NConv2d(num_channels, num_channels, (5, 5), self.pos_fn, 'x', padding=2)
        
        self.nconv4 = NConv2d(2*num_channels, num_channels, (3, 3), self.pos_fn, 'x', padding=1)
        self.nconv5 = NConv2d(2*num_channels, num_channels, (3, 3), self.pos_fn, 'x', padding=1)
        self.nconv6 = NConv2d(2*num_channels, num_channels, (3, 3), self.pos_fn, 'x', padding=1)
        
        self.nconv7 = NConv2d(num_channels, 1, (1, 1), self.pos_fn, 'x')
