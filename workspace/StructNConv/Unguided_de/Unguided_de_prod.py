...
from modules.StructNConv.e_prod_KernelChannels5_prod import e_prod_KernelChannels5

from modules.StructNConv.StructNMaxPool2D_e_prod import StructNMaxPool2D_e
from modules.StructNConv.StructNMaxPool2D_d_with_e import StructNMaxPool2D_d_with_e

from modules.StructNConv.StructNConv2D_e_with_d_prod import StructNConv2D_e_with_d
...
class CNN(torch.nn.Module):
    ...
    def forward(self, d_0, cd_0, e_0=None, ce_0 = None):
        ...
        e_prod = self.e_prod_1(e_0, ce_0)
        d_0, cd_0 = self.nconv_d[1](d_0, cd_0, e_0, ce_0, e_prod)
        e_0, ce_0 = self.nconv_e[2](d_0, cd_0, e_0, ce_0)
        e_prod = self.e_prod_1(e_0, ce_0)
        d_0, cd_0 = self.nconv_d[2](d_0, cd_0, e_0, ce_0, e_prod)
